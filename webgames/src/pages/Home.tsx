...
export default function Home() {
  ...
  const isOnConvergenceAISubdomain =
    window.location.hostname.includes("convergence.ai");
        ...
        <div className="container mx-auto px-2 py-16">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-12 gap-4">
            ...
            <div className="flex gap-4 items-center">
              {isOnConvergenceAISubdomain && (
                <a
                  href="https://github.com/convergence-ai/webgames"
                  target="_blank"
      ...
      <div className="bg-blue-50/40">
        <div className="container mx-auto px-2 py-8">
          ...
          <footer className="mt-8 text-center text-sm text-gray-500">
            Built by{" "}
            {isOnConvergenceAISubdomain ? (
              <a href="https://convergence.ai">convergence.ai</a>
            ) : (
              "Anon"
            )}
          </footer>
